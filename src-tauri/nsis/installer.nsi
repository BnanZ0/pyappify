...
Function GetFirstNonCDriveCallback
  ; $0 = drive root path ("X:\")
  StrCpy $R9 $0 1 ; Get drive letter
  ${If} $R9 == "C"
  ${OrIf} $R9 == "c"
    Push "" ; Continue searching
  ${Else}
    StrCpy $FirstNonCDrive $0
    Push "Stop" ; Found it, stop searching
  ${EndIf}
FunctionEnd

Function GetFirstNonCDrive
